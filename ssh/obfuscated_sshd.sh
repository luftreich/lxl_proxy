...
:orz
ping   $host_addr -n 5
plonk "$host_addr" -C -N -D $forward_port -ssh -2 -P $srv_port -Z $key_code -l $gfw_user -pw "$passwd" -i ${win32_key_file} -v
goto orz
...
_EOF
    ...
    [ -d /work/ftp ] && \cp -avf $pkg_dir/anti_gfwin32.7z /work/ftp
    echo 'Password: 1234'
    echo "Download: ftp://$host_addr/anti_gfwin32.7z"
    sync
}
